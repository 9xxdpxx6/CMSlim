			...
			<div class="row details_row">
				...
				<div class="col-lg-6">
					<div class="details_image">
						...
						@endphp
						<div class="details_image_large"><img src="/images/{{ $image }}" alt="{{ $item->title }}"></div>
						<div class="details_image_thumbnails d-flex flex-row align-items-start justify-content-between">
							@if ($image != 'no_image.png' && count($item->images) > 1)
				...
				<div class="col-lg-6">
					<div class="details_content">
						...
						<div class="in_stock_container">
							...
							@else
								<span style="color: #E95A5A;">нет в наличии</span>
							@endif
						</div>
			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						...
						@foreach ($item->category->products as $product)
							<!-- Product -->
							@php
